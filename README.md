...
| Recognition | Details |
|---|---|
| **AI in Production** | Claude-powered summarisation running inside CRM record pages via Named Credentials, with rate limiting and data protection gating |
| **Developer Tooling** | MCP server exposing 22 typed tools of a 3CX V20 phone system to LLM agents |
| **Open Source** | [WPTrustRocket](https://github.com/MGue95/wptrustrocket) — Trusted Shops review plugin with Oxygen Builder integration and JSON-LD structured data |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:64748B,50:334155,100:0F172A&height=130&section=footer" width="100%" alt="footer" />
